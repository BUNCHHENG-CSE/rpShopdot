            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-10 col-lg-8">
                        ...
                        <h5 class="display-5 mb-4 mb-md-5 mb-xl-8">We're always on the lookout to work with new
                            clients. Please get in touch in one of the following ways.</h5>
                    </div>
                </div>
            </div>
                        ...
                        <div class="border overflow-hidden">
                            ...
                            <form action="#!">
                                <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                                    ...
                                    <div class="col-12">
                                        <div class="d-grid">
                                            <button class="btn btn-lg" style="background-color: #1e1e1e; color: #fff;" type="submit">Send
                                                Message</button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-xl-11">
                                <div class="mb-4 mb-md-5">
                                    ...
                                    <div>
                                        ...
                                        <address class="m-0 text-secondary">450, st.310, Boeung Keng Kang, Cambodia</address>
                                    </div>
                                </div>
                                            ...
                                            <div>
                                                ...
                                                <p class="mb-0">
                                                    <a class="link-secondary text-decoration-none"
                                                        href="tel:+15057922430">+855 123456 | +855 987654</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-6">
                                        <div class="mb-4 mb-sm-0">
                                            ...
                                            <div>
                                                ...
                                                <p class="mb-0">
                                                    <a class="link-secondary text-decoration-none"
                                                        href="mailto:demo@yourdomain.com">info@company.com | mail@business.com</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
