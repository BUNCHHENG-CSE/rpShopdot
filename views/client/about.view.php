	...
	<div class="container">
		...
		<div class="row" style="display: flex; justify-content: center; align-items: center;">
			<div class="col-md-8 col-md-offset-2">
				<form class="form-inline" style="display: flex; justify-content: center; align-items: center; width: 100%;">
					<div class="col-md-6 col-sm-6">
						<div style="display: flex; justify-content: center;">

							<input type="email" class="form-control" style="width: 90%; height: 54px;" id="email" placeholder="Email">
						</div>
					</div>
